...
const rawProducts: Product[] = [
  ...
  },
  {
    ...
    "price": 8.29,
    "originalPrice": 12.43,
    "description": "The Zkittlez is a premium disposable vape engineered for outstanding flavor and reliable delivery. Fruit-forward disposable with sweet, candy-inspired flavour notes. With an ergonomic design and high-grade safety protections, it ensures a consistent, satisfying puff every time. Ideal for both daily users and collectors seeking genuine quality. Fully authentic, certified, and sourced directly from audited manufacturer batches.",
    "badge": "Popular",
    "category": "disposable",
    "image": "/images/17.jpg",
    "variants": [
  ...
  },
  {
    ...
    "price": 29.99,
    "originalPrice": 45.00,
    "description": "Premium THC vape pod with sleek black battery. Clean hits and strong potency.",
    "badge": "new",
    "category": "thc-carts",
...
export const products: Product[] = rawProducts.map(p => ({
  ...p,
  image: p.image.match(/plug_play|select_elite|cookies|heavy_hitters|jeeter|kushy|muha|raw|stiiizy|alien|big_chief|rove|17\.jpg/)
    ? p.image
